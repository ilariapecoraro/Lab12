...
class View:
    ...
    def load_interface(self):
        ...
        # Riga 3
        self.pulsante_cammini = ft.ElevatedButton("Cammino Minimo", width=300,
                                                  on_click=self.controller.handle_cammini if self.controller else None)
